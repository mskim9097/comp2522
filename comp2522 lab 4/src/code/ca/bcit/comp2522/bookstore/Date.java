...
public class Date implements Printable
{
    ...
    /**
     * Displaying the date in the format "YYYY-MM-DD".
     */
    @Override
    public void display()
    {
        System.out.println("This date is " + getYyyyMmDd() + ".");
    }
    ...
    public String getDayOfTheWeek()
    {
        ...
        // 기존: (month == JANUARY || month == FEBRUARY)
        if (isLeapYear(year) &&
                (monthOffset == JANUARY || monthOffset == FEBRUARY))
        {
